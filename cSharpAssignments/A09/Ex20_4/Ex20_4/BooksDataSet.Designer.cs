...
namespace Ex20_4.BooksDataSetTableAdapters {
    ...
    public partial class AuthorISBNTableAdapter : System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ex20_4.Properties.Settings.Default.BooksConnectionString;
        }
    ...
    public partial class TitlesTableAdapter : System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        ISBN, title, editionNumber, description, publisherID, copyright, im" +
        ...
        public virtual int FillByTitle(BooksDataSet.TitlesDataTable dataTable, string @Param1) {
        ...
        public virtual BooksDataSet.TitlesDataTable GetDataByTitle(string @Param1) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((@Param1 == null)) {
                throw new System.ArgumentNullException("@Param1");
            }
