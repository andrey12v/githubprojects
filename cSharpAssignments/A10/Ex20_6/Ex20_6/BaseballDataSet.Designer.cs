...
namespace Ex20_6.BaseballDataSetTableAdapters {
...
SELECT PlayerID, FirstName, LastName, BattingAverage FROM Players WHERE (PlayerID = @PlayerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ex20_6.Properties.Settings.Default.BaseballConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT     PlayerID, FirstName, LastName, BattingAverage\r\nFROM         Players\r\nW" +
                "HERE     (BattingAverage >= @Param1) AND (BattingAverage < @Param2)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param1", global::System.Data.SqlDbType.Decimal, 5, global::System.Data.ParameterDirection.Input, 3, 3, "BattingAverage", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param2", global::System.Data.SqlDbType.Decimal, 5, global::System.Data.ParameterDirection.Input, 3, 3, "BattingAverage", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param1", global::System.Data.SqlDbType.VarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "LastName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByBetAverage(BaseballDataSet.PlayersDataTable dataTable, decimal Param1, decimal Param2) {
        ...
        public virtual BaseballDataSet.PlayersDataTable GetDataByBetAverage(decimal Param1, decimal Param2) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(Param1));
            this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(Param2));
            BaseballDataSet.PlayersDataTable dataTable = new BaseballDataSet.PlayersDataTable();
