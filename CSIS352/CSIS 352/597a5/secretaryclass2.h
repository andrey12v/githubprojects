...
#ifndef _SECRETARYCLASS2_
#define _SECRETARYCLASS2_
#include <string>
#include <list>
#include <iterator>
#include <iostream>
...
// The class Secretary 2 is inherited from the classes Secretary, Full 
...
// without an object. 
// The class Secretary 2 has virtual inheritance which helps to solve the problems of 
...
// the same name of methods. The class Secretary 2 has the method Report() 
// that outputs basic duties of the classes Secretary and Secretary 3. 
// The method Report also outputs specific duties of the class Secretary 2. 
// **************************************************************************

class SecretaryClass2 : virtual public Secretary, virtual public FullTimeEmployee, 
			virtual public HourlyEmployee
{
   public:
	  ...
	  // specific duties of class Secretary 2. The method also outputs 
	  // basic duties of the classes Secretary and Secretary 3. The 
	  ...
	  // output the secretary's classification as Secretary 2
